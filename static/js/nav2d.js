    ...
    var pannavfunction = function(event, mouseState) {
	    ...
	    console.log(mouseState)
            if (mouseState === 'down') {
                ...
                if (navigation == true) {
                    if(room_nav==true){
                        if(confirm("Do you want to save pose ?")==true){
                        alert("pose saved");
                        sendGoal(pose);
                        room_nav=false;
                        }
                    ...
                    if(corridor_nav==true){
                    //send_pose=JSON.stringify(pose);
                    text ="Do you want to save pose ?"
                    if(confirm(text)==true){
                    var posename = prompt("Please enter the name of the pose");
                    ...
                    if (posename) {
                        ...
                        $.ajax({
                            ...
                            type: 'POST',
                            data: posename+"* "+JSON.stringify(send_pose),
                        ...
                        sendGoal(pose);
                        corridor_nav=false;
                        alert(posename+" Saved!")
            
            
                     }
                     // else {
                    //     alert("enter valid pose name to save");
                    // }
