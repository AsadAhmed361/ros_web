...
var pathed = true;
var homing = false;
var MAP_WIDTH = (window.innerWidth)*0.45;
var MAP_HEIGHT = window.innerHeight*0.70;
var v =   current_map;//"terrace";// document.cookie;
var v1=v.replace("[","");
var v2=v1.replace("]","");
var v3=v2.replace(/['"]+/g,"");
var value = v3;
...
$(document).ready(function() {
    ...
    window.zoomOutMap = function(ros, viewer) {
        ...
        zoom.startZoom(250, 250);
        zoom.zoom(0.8);
        console.log(JSON.stringify(send_pose));
    }
    ...
    $("#room_navigate").click(function(event) {
        event.preventDefault();
